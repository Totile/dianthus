...
class Button {
   public:
    ...
    unsigned int getPushDebounceInterval() const {
        return _pushDebounceInterval;
    };
    void setPushDebounceInterval(unsigned int debounce) {
        _pushDebounceInterval = debounce;
    };
    void setReleaseDebounceInterval(unsigned int debounce) {
        _releaseDebounceInterval = debounce;
    };
